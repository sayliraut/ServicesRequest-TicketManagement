<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="font-bold text-3xl text-gray-900 dark:text-white">Manage Service Requests</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">View and handle all service requests</p>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-gray-600 dark:text-gray-400 text-sm font-medium">Open</p>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-gray-600 dark:text-gray-400 text-sm font-medium">Closed</p>
            ...
            <div class="p-6">
                        ...
                        <table class="w-full text-sm">
                            <thead>
                                <tr class="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                                    ...
                                    <th class="text-left px-4 py-3 font-semibold text-gray-700 dark:text-gray-300">Agent</th>
                            ...
                            <tbody>
                                @foreach($tickets as $ticket)
                                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                        <td class="px-4 py-3 font-medium text-gray-700 dark:text-gray-300">#{{ $ticket->id }}</td>
                                        <td class="px-4 py-3">
                                            <span class="text-gray-900 dark:text-white font-medium truncate max-w-xs">{{ $ticket->subject }}</span>
                                        </td>
                                        <td class="px-4 py-3 text-gray-900 dark:text-white">{{ $ticket->user->name }}</td>
                                        <td class="px-4 py-3">
                                        ...
                                        <td class="px-4 py-3 text-gray-900 dark:text-white">{{ $ticket->agent?->name ?? 'Unassigned' }}</td>
                ...
                @else
                    <div class="text-center py-12">
                        <p class="text-gray-500 dark:text-gray-400">No service requests found.</p>
                    </div>
                @endif
            </div>
        </div>
